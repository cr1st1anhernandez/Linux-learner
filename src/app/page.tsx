...
export default function Home(): JSX.Element {
  return (
    <section className="mx-auto flex flex-col items-center justify-center red-light md:w-5/6 xl:flex-row dark:red-dark">
      <article className="flex animate-fade-down animate-once h-fit flex-col justify-center gap-2 sm:gap-8 xl:w-1/2">
      ...
      <div className="flex w-full animate-fade-down animate-once items-center justify-center md:w-2/3 xl:w-1/2">
        <Image
